...
void W_Init(void) {
	...
	if ((doom64superexpluswad = I_FindDataFile("doom64superex-plus.wad"))) {
		W_MergeFile(doom64superexpluswad);
		free(doom64superexpluswad);
	}
	else {
		I_Error("W_Init: doom64superex-plus.wad not found");
	}
