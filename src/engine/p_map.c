...
boolean PIT_RadiusAttack(mobj_t* thing) {
    ...
    if (thing->type == MT_CYBORG || thing->type == MT_SPIDER || thing->type == MT_ANNIHILATOR || thing->type == MT_BFGCYBERDEMON || thing->type == MT_NIGHTCRAWLER || thing->type == MT_BRUISERDEMON) {
        return true;
    }
